...
TwitterPlaysPiano is an experimental music performance project. It consists of a software instrument that is played through Twitter Tweet data by multiple performers. Detailed below are the instructions to run a Twitter Plays Piano performance session.

=====================================
For TwitterPlaysPiano Session Hosts
=====================================

-Mac only, Windows version coming soon (maybe)
-Download and unzip the TwitterPlaysPiano folder from bpcook.com/twitterplayspiano
-Move the TwitterPlaysPiano folder wherever you would like
-Keep the TwitterPlaysPiano intact
-You may drag a shortcut to your dock, desktop, or wherever 
-If you do not have Tweepy installed for Python then please open the "InstallTweepy" file, enter your password, and hit enter. If you don't know what Tweepy is, then you probably don't have it installed, so this step will be required.  
...
-When people choose a timbre and the program is running in "MIDI Out" mode, their timbre chose represents a change in MIDI channel 1-16.
-Otherwise enjoy 16 fabulous internal MIDI sounds of the utmost quality 
...
Uses Tweepy for Python library
Max Application includes Shell object written by Jeremy Bernstein 

BPCook.com/TwitterPlaysPiano
